...
`,
  faqs: [
    { q: "How long do you need at the Grand Egyptian Museum?",
      a: "Half a day is the realistic minimum to see all twelve galleries at a steady pace. Two hours covers the Grand Staircase and the Tutankhamun collection and nothing else. A full day lets you include the solar boat building without rushing." },
    { q: "Is the Grand Egyptian Museum better than the Egyptian Museum in Tahrir?",
      a: "They are different rather than ranked. Giza is spacious, well lit and easier to follow, and holds the complete Tutankhamun collection. Tahrir is dense and atmospheric and suits return visitors. If you have one day, go to Giza." },
    { q: "When is the Grand Egyptian Museum least crowded?",
      a: "The first hour after opening on a weekday. Late morning through early afternoon is the busiest window, when coach groups arrive from the pyramids. Fridays and public holidays are busier with local visitors." },
    { q: "Is the full Tutankhamun collection at the Grand Egyptian Museum?",
      a: "Yes. For the first time the complete contents of the tomb, over five thousand objects, are displayed together in dedicated galleries rather than as the smaller selection that used to be shown in Tahrir." },
    { q: "Can you visit the Grand Egyptian Museum and the pyramids in one day?",
      a: "Yes, and the order matters. Do the pyramids at sunrise and the museum from mid morning. Doing it the other way round puts you on the plateau in flat midday light after hours of walking indoors." },
    { q: "Do you need to book Grand Egyptian Museum tickets in advance?",
      a: "In high season yes, because entry is timed. Booking ahead also avoids the entry queue. Photography rules vary by gallery and the restricted ones are signed at the door." },
    { q: "Is the Grand Egyptian Museum suitable for children?",
      a: "It suits children better than most Egyptian museums because the labels are written plainly and there is room to move. The main limit is walking distance, so plan a break and use the seating rather than pushing through in one go." },
  ],
};
