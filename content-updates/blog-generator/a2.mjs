...
`,
  faqs: [
    { q: "How long do you need at the Grand Egyptian Museum?",
      a: "Half a day, about 4 hours, is the realistic minimum for all 12 galleries at a steady pace. 2 hours covers the Grand Staircase and the Tutankhamun collection and nothing else. A full day lets you add the solar boat building and sit with what you liked rather than walking past most of it." },
    { q: "Is the Grand Egyptian Museum better than the Egyptian Museum in Tahrir?",
      a: "They are different rather than ranked. The Giza building is spacious, well lit and easier to follow, and holds the complete Tutankhamun collection of over 5,000 objects. Tahrir is dense, dim and atmospheric and suits return visitors. If you have 1 day, go to Giza; if you have 2, do both and put Tahrir second." },
    { q: "When is the Grand Egyptian Museum least crowded?",
      a: "The first hour after opening on a weekday. The Tutankhamun galleries go from comfortable to congested at around 11am, when coach groups arrive from the pyramids. If you are stuck in that window, start at the far chronological galleries and work back toward Tutankhamun in the late afternoon instead." },
    { q: "Is the full Tutankhamun collection at the Grand Egyptian Museum?",
      a: "Yes. For the first time the complete contents of the tomb, more than 5,000 objects, are displayed together in dedicated galleries. Tahrir used to show a much smaller selection. This is the single reason most visitors travel to the Giza building rather than treating it as an optional extra stop." },
    ...
    { q: "What should you see first at the Grand Egyptian Museum?",
      a: "The Grand Staircase, on foot rather than by lift. It climbs 6 storeys lined with royal statues and sarcophagi arranged chronologically, and the window at the top frames the Giza pyramids directly. Go to the Tutankhamun galleries next, because that is the one room most people regret rushing." },
  ],
};
