export default {
  ...
  rewriteOf: "is-egypt-safe-for-american-tourists",
  primary: "is egypt safe for americans",
  secondary: [
    "is it safe for americans to travel to egypt",
    "is egypt safe to visit for americans",
    "how safe is egypt for americans",
  ],
  ...
  excerpt:
    "Level 2, the same level as France, Germany and the UK, with two specific regions excluded entirely. Here is what the advisory actually says and where the lines are drawn.",
  heroAlt:
    "American visitors walking with their guide at Karnak, part of answering is egypt safe for americans",
  wordRange: [1800, 2000],
  body: `
<p><strong>Last reviewed: September 2026.</strong> Advisories change. Read the official page linked below before you travel rather than relying on any summary, including this one.</p>
...
`,
  faqs: [
    { q: "Is Egypt safe for American tourists right now?",
      a: "The US State Department has Egypt at Level 2, Exercise Increased Caution, which is the same level as France, Germany, Italy and the United Kingdom. 2 regions are excluded at Level 4, Do Not Travel: Northern and Middle Sinai, and parts of the Western Desert. Neither sits on a standard itinerary." },
    { q: "What does a Level 2 travel advisory mean?",
      a: "Exercise Increased Caution, the second of 4 levels. It means identified risks exist that a traveller should account for, and the advisory names them. Most of Western Europe carries the same level. It is 2 steps below Do Not Travel and is not a recommendation against going, but it is not nothing either." },
    { q: "Is the Western Desert safe to visit?",
      a: "Parts of the Western Desert are at Level 4, Do Not Travel, and any source that says the whole desert is fine is misreading the advisory. Bahariya and the White Desert are visited on permitted routes with a licensed operator holding the required permits, which is also the legal condition for being in a national park." },
    { q: "Is Sinai safe?",
      a: "Northern and Middle Sinai are at Level 4, Do Not Travel, and have been for years. The South Sinai resort area around Sharm el Sheikh and Dahab is treated separately and is where the diving happens. Access to St Catherine's has its own restrictions that change, so check the current position before relying on it." },
    { q: "What is the difference between the biggest actual risk in Egypt and the one people worry about?",
      a: "Road traffic, by a wide margin, ahead of anything on the security page. Egyptian roads are fast, dense and governed by convention rather than rule, and deaths per vehicle are high. Heat is 2nd, particularly in the Valley of the Kings between May and September. Violent crime against visitors is rare." },
    { q: "Is Egypt safe to visit for American women alone, or is it better as a couple?",
      a: "Yes, with the caveat that street harassment is common and mostly verbal. It is wearing rather than threatening and it is worst in crowded parts of Cairo. 3 things reduce it: travelling with a guide, covering shoulders and knees away from resorts, and using arranged transport instead of hailing in the street." },
    { q: "Is Egypt more dangerous than a European city, or is that a difference of perception?",
      a: "On violent crime rates they are comparable, and Egypt's serious risk is concentrated in 2 named regions rather than spread nationally, which is why the advisory is regional. The genuine difference is the road, where Egypt is clearly more dangerous. That argues for a driver rather than a hire car, not against the trip." },
    { q: "Should you enrol in STEP before travelling?",
      a: "Yes. STEP is the State Department's free Smart Traveler Enrollment Program, and it puts you on the US Embassy Cairo list for alerts and makes you easier to reach in an emergency. It takes about 5 minutes. Pair it with travel insurance that covers medical evacuation, which matters more here than most people expect." },
  ],
};
