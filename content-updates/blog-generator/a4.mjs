...
`,
  faqs: [
    { q: "How many days do you need in Luxor?",
      a: "Two full days is the honest minimum, one for each bank of the Nile. Three is comfortable and leaves room for the Valley of the Queens or a day trip north to Dendera. One day is a highlights visit rather than a proper look." },
    { q: "Should I do the west bank or the east bank first?",
      a: "West bank first, starting at first light. It is open desert with no shade and a lot of climbing, so it has to happen early. The east bank temples work better in the late afternoon and evening." },
    { q: "Is Karnak or Luxor Temple better?",
      a: "Karnak is larger and more overwhelming and needs about three hours. Luxor Temple is smaller and at its best after dark, when it is lit and sits in the middle of the modern town. See both, and see Luxor Temple at night." },
    { q: "What is the best thing to do in the middle of the day in Luxor?",
      a: "The Luxor Museum. It is air conditioned, beautifully lit, and takes about an hour, which makes it the ideal use of the hours when everything outdoors is too hot. Very few itineraries place it there." },
    { q: "Is a hot air balloon over Luxor worth it?",
      a: "Yes, and it is the one thing to book before you arrive because capacity is limited and it sells out in high season. It launches before sunrise, lasts about an hour, and gives you the whole west bank geography at once." },
    { q: "When is the best time of year to visit Luxor?",
      a: "October to April. Between June and September the middle of the day is genuinely difficult and every plan has to shift earlier, with the west bank finished before ten and the east bank left until evening." },
  ],
};
