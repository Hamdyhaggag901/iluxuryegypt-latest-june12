...
`,
  faqs: [
    { q: "How many days do you need in Luxor?",
      a: "2 full days is the honest minimum, 1 for each bank of the Nile. 3 is comfortable and leaves room for the Valley of the Queens or a day trip to Dendera. 1 day is a highlights visit: you will see the Valley of the Kings and Karnak, and you will not see Luxor." },
    { q: "Should you do the west bank or the east bank first?",
    ...
    { q: "Which is better, Karnak or Luxor Temple?",
      a: "Karnak is the larger and more overwhelming of the 2 and needs about 3 hours; its hypostyle hall alone holds 134 columns, the tallest around 21 metres. Luxor Temple is smaller and at its best after dark, lit and sitting in the middle of the modern town. See both, and see Luxor Temple at night." },
    { q: "What is the best thing to do in the middle of the day in Luxor?",
      a: "The Luxor Museum. It is air conditioned, beautifully lit and takes about 1 hour, which makes it the ideal use of the hours when everything outdoors is too hot. It holds 2 royal mummies and a cache of statues found buried under Luxor Temple in 1989. Very few itineraries schedule it there." },
    { q: "Is a hot air balloon over Luxor worth booking?",
      a: "Yes, and it is the 1 thing to book before you arrive, because capacity is limited and it sells out in high season. Flights launch before sunrise and last about 1 hour. Seeing the mortuary temples and the green strip of cultivation from above reorganises the whole geography in your head." },
    { q: "When is the best time of year to visit Luxor?",
      a: "October to April. Between June and September the middle of the day is genuinely difficult for anyone not used to it, and every plan has to shift earlier: west bank finished before 10am, east bank left until evening. Season matters more in Luxor than almost anywhere else in Egypt." },
    { q: "How do you cross between the two banks of the Nile in Luxor?",
      a: "By the local ferry or a private boat, both of which run frequently and take a few minutes. The road bridge is a long way south of the town, so almost nobody drives across. Budget a few minutes each way rather than planning around it, and expect to cross twice in a 2 day visit." },
    { q: "Is Luxor worth staying overnight or is a cruise stop enough?",
      a: "Stay overnight if Luxor is a reason you are coming to Egypt. Most Nile cruises allocate about 1.5 days, which covers Karnak and some tombs and leaves the museum, Medinet Habu and Luxor Temple at night undone. On land you can split the 2 banks across 2 mornings instead of compressing them." },
  ],
};
