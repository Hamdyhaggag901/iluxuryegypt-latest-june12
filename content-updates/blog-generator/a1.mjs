...
`,
  faqs: [
    { q: "How long is the drive from Aswan to Abu Simbel?",
      a: "About 3 to 3.5 hours each way, covering roughly 280 km of desert road. Most road trips leave Aswan between 3am and 4am so you reach the temples before the heat builds. There is no railway and no useful public transport on the route, so nearly everyone books the transport as part of a package." },
    { q: "Is it better to fly or drive to Abu Simbel from Aswan?",
      a: "Fly if your days are short or you are travelling with children or older parents: the flight is about 40 minutes each way and puts you back in Aswan by late morning. Drive if you want the desert crossing and the early light on the temple facade, and you can function on 4 hours of sleep." },
    ...
    { q: "Is one day at Abu Simbel enough, or is an overnight stay worth it?",
      a: "One day is enough for most visitors, because the 2 temples take about 2 hours at an unhurried pace. An overnight in Abu Simbel village is worth it only if you want the site at opening time with almost nobody else there, which is the single thing a day trip from Aswan cannot give you." },
    { q: "What is the best time of year to visit Abu Simbel?",
      a: "October to April. Between May and September the middle of the day is genuinely difficult, with very little shade on the 10 minute walk between the car park and the temples. The facade faces east, so it is lit from sunrise until about 10am in any season, which is the real argument for arriving early." },
    { q: "Why were the Abu Simbel temples moved?",
      a: "To save them from Lake Nasser, which rose behind the Aswan High Dam. Between 1964 and 1968 both temples were cut into more than 1,000 blocks, lifted about 65 metres up and 200 metres back from the original cliff, and rebuilt inside a hollow artificial hill. The cut lines are still visible on the colossi." },
  ],
};
