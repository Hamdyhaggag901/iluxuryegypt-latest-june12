export default {
  ...
  titleEn: "Best Luxury Nile Cruise: Choosing by Category",
  metaTitle: "Best Luxury Nile Cruise: How to Choose Yours",
  metaDescription:
    "The best luxury nile cruise is a category decision before it is a boat decision. Dahabiya, boutique ship or large cruiser, and the questions that separate them.",
  excerpt:
    "No boat names, no invented features. The three categories on the river, what genuinely differs between them, and the eight questions worth asking before you pay a deposit.",
  heroAlt:
    "A sailing dahabiya moored against a quiet bank at dusk on the best luxury nile cruise route",
  wordRange: [1800, 2000],
  body: `
<p>Choose the category before you choose the boat. Three exist on this river: the sailing dahabiya, the boutique motor ship, and the large cruiser. They differ in where they can moor, how many people are aboard and how fast they move, and those three things decide almost everything about the week.</p>
...
`,
  faqs: [
    { q: "What is the difference between a dahabiya and a Nile cruise ship?",
      a: "A dahabiya sails, carries a handful of cabins, and moors at banks and islands the bigger boats cannot reach. A cruise ship runs on engines, carries tens or hundreds of cabins, and ties up at main quays sometimes 4 or 5 boats deep. The first is quieter, the second has a pool." },
    { q: "How many nights should a Nile cruise be?",
      a: "4 nights is the standard and 5 is better. 4 covers Aswan, Kom Ombo, Edfu, Esna and Luxor with a full day at each end. The 5th night adds a day with nothing scheduled, which on a sailing boat is often the day people describe most warmly afterwards. 3 nights is only a taste." },
    { q: "Which is better, Aswan to Luxor or Luxor to Aswan?",
      a: "Aswan to Luxor, in almost every case. Downstream is the gentler of the 2 directions, the sailing is slower, and the sites arrive in a sensible order that leaves the Luxor west bank ahead of you rather than behind. Fly into 1 end and out of the other rather than doubling back." },
    { q: "When is the best time for a Nile cruise?",
      a: "October to April, with late October, November, February and March the best 4 months of that window. The river is where Egyptian summer heat is hardest, because deck shade is limited and the temples are open sites. December and January are excellent and the boats for those weeks book furthest ahead." },
    { q: "What should you ask before booking a Nile cruise?",
      a: "8 questions. Is the boat private or are you buying cabins, how many cabins in total, where it moors each night by name, what time you reach each temple, whether the guide is yours throughout, what is included beyond meals, whether there is a single supplement, and what happens if conditions change." },
    { q: "Are drinks and entrance fees included on a Nile cruise?",
      a: "Full board is normal, drinks usually are not, and entrance fees vary between operators. Crew tips are separate everywhere and are generally collected once at the end. Check those 3 lines specifically, because on a week aboard they are the difference between the advertised price and what you actually pay." },
    { q: "Is a Nile cruise worth it compared with staying in hotels?",
      a: "Yes, for 1 structural reason: the temples between Aswan and Luxor sit on the river, so the boat takes you to them while you sleep. Doing the same route by road means 4 or 5 hotel changes and several hours in a car each day, for more money and considerably more effort." },
    { q: "Which deck should you choose on a Nile cruise boat?",
      a: "Upper, and it is worth the supplement here more than on most trips. Lower deck cabins can sit close to waterline with a view of a quay wall, and you spend far more waking hours looking out of a cabin window on a river boat than in a hotel. Ask for windows rather than portholes, and check which of the 3 decks it sits on." },
  ],
};
