export default {
  ...
  primary: "bahariya oasis egypt",
  secondary: ["bahariya oasis", "bahariya oasis tour", "bahariya oasis hotels"],
  wave: "two-december",
  category: "Destinations",
  tags: ["Bahariya", "Western Desert", "Bawiti", "Golden Mummies"],
  titleEn: "Bahariya Oasis Egypt: Springs, Golden Mummies and Black Hills",
  metaTitle: "Bahariya Oasis Egypt: Springs, Mummies, Black Hills",
  metaDescription:
...
`,
  faqs: [
    { q: "Is Bahariya Oasis worth staying in, or just passing through?",
      a: "Worth at least 1 night and better with 2. Most visitors change vehicles and drive straight out to the desert, which misses the hot springs, the Greco Roman mummy museum, 2 open Twenty Sixth Dynasty tombs and the sunset view from the English Mountain. The springs alone justify the stop." },
    { q: "How far is Bahariya Oasis from Cairo?",
      a: "About 365 kilometres southwest, which is 4 to 5 hours by road on tarmac the whole way. It is the closest of the Western Desert oases to the capital, and that proximity is why it became the gateway to the White Desert even though Farafra sits nearer to the chalk formations." },
    { q: "What are the Golden Mummies of Bahariya?",
      a: "A Greco Roman cemetery found in 1996 and excavated from 1999, dating roughly from the 1st to the 4th century AD. The name comes from gilded cartonnage masks over painted chest plates. Estimates run into the thousands of burials with only a fraction excavated, and a selection is displayed in a small museum in Bawiti." },
    { q: "Which is better, Bahariya or Siwa?",
      a: "Bahariya for a short trip, Siwa for a real one. Bahariya is 4 to 5 hours from Cairo and works as a 2 night stop attached to the desert. Siwa is roughly 10 hours away, has its own language and culture, a fortress town and a salt lake, and deserves 3 or 4 nights on its own terms." },
    { q: "Can you swim in the springs at Bahariya?",
      a: "Yes, in several, and the 2 types are used differently. The cold springs such as Bir al Ghaba are for swimming, and the hot boreholes such as Bir Sigam are for soaking, with some running too hot to enter immediately. These are semi public places in a conservative rural area, so women should plan to swim covered or choose a hotel with its own pool." },
    { q: "What kind of hotels are there in Bahariya?",
      a: "Small, simple and family run, often mud brick, with several out in the palm groves rather than in Bawiti itself. There is no international chain and no bar. The 1 feature worth asking about is whether the property has its own spring fed pool, because that decides what the evenings are like." },
    { q: "When is the best time to visit Bahariya Oasis?",
      a: "December to February, with warm days around 20 degrees and cold nights. That is also the season for the desert camping most visitors combine it with. Summer from June to August is very hot, the region slows down, and most desert operators suspend overnight trips into the sand altogether." },
    { q: "Do you need cash in the oasis?",
      a: "Yes, and this catches people out. Card acceptance in Bahariya is limited in a way it no longer is in Cairo or Luxor, and the small hotels, the museum, the tomb tickets and the springs are cash places. Draw what you need for 2 or 3 days before leaving the capital." },
  ],
};
