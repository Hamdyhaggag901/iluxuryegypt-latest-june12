export default {
  ...
  rewriteOf: "things-to-know-before-traveling-to-egypt",
  primary: "egypt travel tips",
  secondary: ["cairo egypt travel tips", "travel tips for egypt"],
  wave: "rewrite-phase-c",
  category: "Travel Tips",
  tags: ["Travel Tips", "Before You Go", "Cairo"],
  titleEn: "Egypt Travel Tips That Change the Day",
  metaTitle: "Egypt Travel Tips: What Actually Matters There",
  metaDescription:
    "The egypt travel tips that come up every single day: tipping, cash, water, what to wear, and how to handle the selling. Written from the ground, not a listicle.",
  excerpt:
    "Tipping, cash, water, dress and the selling. The handful of things that decide whether a day here runs smoothly, and the ones that turn out not to matter at all.",
  heroAlt:
    "A busy Cairo street at dusk with a tea seller, the setting behind most egypt travel tips",
  wordRange: [1800, 2000],
  body: `
<p>Carry small notes for tipping, drink only bottled or filtered water, cover shoulders and knees at religious sites, and treat every quoted price as an opening position. Those four cover most of the difference between a smooth day here and a frustrating one. The rest is detail.</p>
...
`,
  faqs: [
    { q: "How much should you tip in Egypt?",
      a: "Small amounts, constantly. Baksheesh is given for a service rendered: carrying a bag, watching a bathroom, handling a boat. Carry a thick wad of the 2 or 3 smallest note denominations and keep them apart from your real money. For a guide or driver on a longer trip, 1 sum at the end is normal." },
    { q: "Can you drink the tap water in Egypt?",
      a: "No, and do not bend the rule for teeth brushing either. The issue is a different mineral and bacterial profile from the one you are used to, and the cost of ignoring it is about 2 days you did not plan for. Check bottle seals and skip ice outside places you have chosen carefully." },
    { q: "What should women wear in Egypt?",
      a: "Shoulders and knees covered in cities and at temples, anything at all at a Red Sea resort or a hotel pool. Mosques ask for covered arms, legs and hair, so 1 scarf in the day bag settles it. Closed shoes with grip at every site, because sand and worn stone are not sandal territory." },
    { q: "Is it better to use cash or cards in Egypt?",
      a: "Both, in different places. Cards work in hotels, good restaurants and larger shops, and everything else is cash. Withdraw from a bank ATM rather than a lobby machine, take out a decent amount at a time to avoid paying a fee 5 times a week, and tell your bank before you travel." },
    { q: "How do you handle haggling in Egyptian markets?",
      a: "Decide what it is worth to you, open well below that, and settle in between. Walking away cheerfully is a normal move rather than an insult and often produces a better price 10 seconds later. Fixed price shops are marked and should not be haggled in, and no gift offered to you is free." },
    { q: "Which is more useful in Cairo, taxis or ride hailing apps?",
      a: "Apps, in almost every case. They remove the fare negotiation entirely, which on a 35 degree afternoon is worth the small premium. Street taxis need the price agreed before you get in. The metro is fast and cheap and has carriages reserved for women, and it beats both in rush hour." },
    { q: "What time of day should you sightsee in Egypt?",
      a: "Start at opening and stop by noon, then go out again after 4pm. Between May and September the middle of the day is not usable, and there is no shade at Giza, in the Valley of the Kings or across most of Karnak. This is how people live here rather than a compromise." },
    { q: "Is it worth visiting Egypt during Ramadan?",
      a: "Yes if you are curious, no if you want everything on a normal schedule. Monuments and hotels run as usual, but restaurants outside hotels may close during daylight and the country slows for several hours in the afternoon. The dates move about 11 days earlier each year, so check them against your own rather than assuming." },
  ],
};
