export default {
  ...
  rewriteOf: "do-us-citizens-need-a-visa-for-egypt",
  primary: "egypt visa for us citizens",
  secondary: [
  ...
  excerpt:
    "Two routes, both straightforward, and one of them can be done from your sofa. What each needs, what catches people out at Cairo arrivals, and where to check the current rules.",
  heroAlt:
    "US passport and boarding pass on a desk while arranging an egypt visa for us citizens",
  wordRange: [1600, 1800],
  body: `
<p><strong>Last reviewed: September 2026.</strong> Entry rules change without much notice. Check the official pages linked below before you travel rather than relying on any summary, including this one.</p>
...
`,
  faqs: [
    { q: "Do US citizens need a visa for Egypt?",
      a: "Yes. There is no visa waiver for US tourists. You can buy one on arrival at a bank counter in the airport before immigration, or apply for an e-visa online in advance at the official portal. Both are tourist visas and both are normally issued for a single entry, valid for a stay of up to 30 days." },
    { q: "Which is better, the e-visa or the visa on arrival?",
      a: "The e-visa if you want it settled before you fly, the visa on arrival if you are being met at the airport. The e-visa removes 1 step from a long arrival day and is paid by card. The arrival counter needs clean US dollar notes in cash and takes a few minutes when the hall is quiet." },
    { q: "How long does the Egypt e-visa take?",
      a: "Often a few days, sometimes much faster, but apply at least 1 week before you fly. That margin is not about the usual case. It is so that a query on your application is something you deal with calmly rather than the night before a flight, when the portal is the worst possible place to find a problem." },
    { q: "How much does an Egypt visa cost for US citizens?",
      a: "The current charge is published on the official Egyptian government portal at visa2.egypt.gov.eg, which is the only place worth reading it. Fees are revised from time to time and commercial sites add their own service charge on top, sometimes doubling what you pay for exactly the same document." },
    { q: "What is the difference between passport validity and the 6 month rule?",
      a: "No, and the difference is what catches people out. Egypt asks for at least 6 months of validity beyond the date you arrive, with at least 1 blank page, rather than simply an unexpired passport. A passport that expires in 4 months is perfectly valid and will still be refused at check-in." },
    { q: "Can you get an Egypt visa at Sharm el Sheikh without paying?",
      a: "Sometimes, and it is narrower than it sounds. Travellers flying into Sharm and staying inside the South Sinai resort area can receive a free entry permission stamp for a short stay. It covers 0 of the Nile valley: not Cairo, not Luxor, not Aswan, so it is no use on any itinerary that leaves the resort strip." },
    { q: "Is the tourist visa single or multiple entry?",
      a: "Single entry as standard, which covers 1 arrival and no more. If your trip leaves Egypt and returns, a side trip to Jordan for example, you need a multiple entry visa arranged in advance through the portal or an Egyptian consulate. Re-entering on a spent single entry visa does not work, and a border is a bad place to find that out." },
    { q: "Where should you check the current rules?",
      a: "2 official pages. The Egyptian government portal visa2.egypt.gov.eg for the e-visa itself and the current requirements, and travel.state.gov for the US State Department's entry and exit information alongside the travel advisory. Every other source is a summary written on a particular day, and requirements change without much notice." },
  ],
};
