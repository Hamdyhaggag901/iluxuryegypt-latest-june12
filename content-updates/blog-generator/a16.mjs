export default {
  ...
  primary: "black and white desert egypt",
  secondary: [
    "black and white desert egypt tours",
    "camping white desert egypt",
    "white desert camp",
  ],
  wave: "one-october",
  category: "Destinations",
  tags: ["Western Desert", "White Desert", "Black Desert", "Bahariya"],
  titleEn: "Black and White Desert Egypt: Two Deserts in One Drive",
  metaTitle: "Black and White Desert Egypt: What the Trip Is Like",
  metaDescription:
...
`,
  faqs: [
    { q: "Is the Black and White Desert worth the trip from Cairo?",
      a: "Yes, if you can give it 2 nights. It is a 4 to 5 hour drive each way to Bahariya, and a day trip that turns round mid afternoon misses the last hour of light and the night sky, which are the 2 best parts. With 2 nights it is the strongest landscape contrast available to a temple itinerary." },
    { q: "Which is better, the White Desert or Siwa Oasis?",
      a: "Different trips entirely. The White Desert is 1 extraordinary landscape and a night camping in it, reachable in 2 or 3 days from Cairo. Siwa is a town, a culture, springs and a salt lake, roughly 10 hours from Cairo and worth 3 or 4 nights. Choose the desert for scenery, Siwa for place." },
    { q: "How cold does it get camping in the White Desert?",
      a: "Close to freezing on winter nights, from December to February, with wind. Daytime in those months is pleasant at around 20 degrees, which catches people out. Pack a down or fleece layer, a hat, socks to sleep in and a windproof shell. Camps supply blankets but they are not sleeping bags." },
    { q: "Can you camp in the White Desert independently?",
      a: "No. It has been a national park since 2002 and overnight stays run through licensed operators who hold the permits. The practical reasons are the same as the legal ones: there is no phone signal, no water and no marked track, and the off road driving between formations needs someone who knows the ground." },
    { q: "How long does the Black and White Desert trip take?",
      a: "2 nights is the realistic minimum and 3 is better. Day 1 is the 5 hour drive from Cairo plus the Black Desert and Crystal Mountain, night 1 is the camp, day 2 covers sunrise and the drive back. A third day adds Bahariya itself, including the springs and the Golden Mummies museum." },
    { q: "What is the Black Desert made of?",
      a: "Dark dolerite, a volcanic rock, broken into fragments that cap and coat hundreds of low conical hills over an orange sandstone plain. It sits about 20 minutes south of Bahariya. The smaller cones take around 10 minutes to climb and the view from the top across the rest of the field is what the stop is for." },
    { q: "What is the best time of year to visit the Western Desert?",
      a: "October to November and March to May. Those 4 months give warm days around 25 degrees and cold but tolerable nights. December to February has the most comfortable daytime temperatures but nights near freezing. June to August is genuinely dangerous in open desert and most operators suspend overnight trips then." },
    { q: "Is there phone signal or electricity at the camps?",
      a: "Neither. Camps are temporary, carried in and out by the operator, with no structures, no plumbing and no power beyond a vehicle. Bring a power bank and a head torch. The lack of signal is the trade for the 1 thing everybody remembers, which is a sky with no light pollution for 100 kilometres." },
  ],
};
