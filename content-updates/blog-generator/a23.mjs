export default {
  ...
  rewriteOf: "best-time-to-visit-egypt",
  primary: "best time to visit egypt",
  secondary: [
  ...
  excerpt:
    "October to April, and November to February if you can choose freely. Here is what each month actually does to a day in Luxor, and the three weeks most people should avoid.",
  heroAlt:
    "Winter morning light on the Giza pyramids, the best time to visit egypt for sightseeing",
  wordRange: [2000, 2300],
  body: `
<p>October to April. If you can pick freely, November to February.</p>
...
`,
  faqs: [
    { q: "What is the best time of year to visit Egypt?",
      a: "October to April, and November to February inside that. Those 4 winter months keep Luxor in the mid 20s by day, which is what makes the Valley of the Kings bearable after 10am. Summer works only with a 6am start and the middle of the day indoors, because Upper Egypt runs past 40 degrees." },
    { q: "Which is better for Egypt, December or February?",
      a: "February, unless you want Christmas in Egypt specifically. The weather is near identical at around 25 degrees in Luxor, but December pricing climbs from about the 20th and stays at the year's peak into early January. February has the same light and a fraction of the cost, with half term weeks the only busy stretch." },
    { q: "What is the hottest month in Egypt?",
      a: "July, with August close behind. Luxor and Aswan sit above 40 degrees most days and have touched the high 40s. Cairo runs about 5 degrees cooler. The heat is the reason summer itineraries start at 6am and go back indoors by 11, rather than a reason to stay away altogether." },
    { q: "Is it worth visiting Egypt in summer?",
      a: "Yes, if the Red Sea is part of the plan or the budget matters more than comfort. Prices fall, the Valley of the Kings is close to empty, and sea temperatures reach 29 degrees. The trade is a 6am start and 5 hours indoors in the middle of every day, which suits some travellers and not others." },
    { q: "When should you avoid Egypt?",
      a: "3 windows. Christmas to the first days of January is the most expensive and most crowded fortnight of the year. The week around Easter overlaps European and Egyptian holidays. Mid July to the end of August in Luxor and Aswan is genuinely punishing rather than merely hot." },
    { q: "How cold does Egypt get in winter?",
      a: "Colder than most people pack for. Luxor and Aswan nights in December and January drop to single figures, sometimes near 5 degrees, while the same day may reach 24. Cairo is similar. Days are shirt weather and evenings on a cruise deck need a proper jacket rather than a light layer." },
    { q: "Does Ramadan affect travel in Egypt?",
      a: "It changes the rhythm, not the access. Every major site stays open and hotels, boats, guides and drivers work normally. Some restaurants close during daylight and a few sites trim their hours. Cairo traffic is worst in the 1 hour before sunset and empty for the hour after. The evenings are the best part of the month to be there." },
    { q: "When is the best time for a Nile cruise?",
      a: "The same window as the temples, October to April, because a cruise is a way of reaching temples. November to February is ideal on deck by day and needs a jacket after dark. Small boats carry around 12 cabins and sell out 8 to 10 months ahead for the winter, far earlier than hotels do." },
  ],
};
