...
`,
  faqs: [
    { q: "How many tombs does the general Valley of the Kings ticket cover?",
      a: "Three, chosen by you from whatever is open on the day. Tombs rotate in and out of closure for conservation, so the available list is usually between eight and a dozen and is not published far in advance." },
    { q: "How many tombs are in the Valley of the Kings in total?",
      a: "Sixty five have been found and numbered, from KV1 to KV65. Only a fraction are open to visitors at any one time, and the open list changes as conservation work moves around the valley." },
    { q: "Which three tombs should I choose?",
      a: "Ramesses VI for its astronomical ceiling, Ramesses III for the daily life scenes in its side chambers, and Merenptah for the scale of the descent. If one is closed, Ramesses IV near the entrance is the easiest substitute." },
    { q: "Is the Tutankhamun tomb worth the separate ticket?",
      a: "Only if the discovery story matters more to you than the painting. The tomb is small and nearly bare because the contents are now in the Grand Egyptian Museum. What remains is the sarcophagus, the outer coffin and the mummy itself." },
    { q: "Is the Seti I tomb worth the extra cost?",
      a: "Yes if you are making one splurge and you care about ancient art. KV17 is the deepest and most completely decorated tomb in the valley and the relief carving is better than anything else on the west bank." },
    { q: "What is the best time of day to visit?",
      a: "Opening time. The valley is a rock bowl with no shade and it holds heat, and the deeper tombs get hot and airless by late morning. Between October and April the timing is more forgiving, but early is still better." },
    { q: "Do I need a photography permit inside the tombs?",
      a: "Usually yes, bought separately at the ticket office, and the rules change from season to season. Ask at the window when you buy your entry rather than finding out at a tomb door." },
  ],
};
