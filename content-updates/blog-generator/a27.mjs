...
`,
  faqs: [
    ...
    { q: "Is cancel for any reason cover worth buying for Egypt?",
      a: "Only when a large share of your trip is non refundable. It costs noticeably more than standard cancellation cover and pays a percentage of the loss rather than all of it, often around half. Book 12 months ahead with heavy deposits and it earns its price. Book late with flexible arrangements and it rarely does." },
    { q: "Which is better for Egypt, an annual policy or single trip cover?",
      a: "Single trip cover, unless you already travel more than twice a year. An annual policy is priced for frequency and its per trip limits are sometimes lower, particularly on evacuation, which is the 1 limit that matters most here. Compare the evacuation figure on both before comparing anything else." },
    { q: "Does travel insurance cover a hot air balloon flight in Luxor?",
      a: "Often not as standard. A sunrise balloon over the west bank is excluded outright by a surprising number of policies and covered by others only as a named activity you add. Check the wording for the words balloon or aerial before you book the flight, and get the insurer's answer in writing. 1 email settles it." },
    { q: "When should you buy travel insurance for a trip to Egypt?",
      a: "The day your first payment leaves your account. Cancellation cover starts on the date of purchase rather than the date of departure, so every 1 of the days you wait leaves deposits uninsured. The medical half does not begin until you travel anyway, which means waiting saves nothing and risks the part that is already live." },
    { q: "What do you do if you need to claim while in Egypt?",
      a: "Call the emergency number on the certificate before anything else, including the hospital. Most policies require notification before treatment beyond a minor consultation, and the assistance company will usually settle directly with the hospital. Photograph all receipts, prescriptions and notes, and keep 2 copies, because claims are decided on paper months later." },
  ],
};
