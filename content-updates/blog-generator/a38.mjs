export default {
  ...
  tags: ["Money", "Before You Go", "Travel Tips"],
  titleEn: "Currency in Egypt: Cash, Cards and Changing Money",
  metaTitle: "Currency in Egypt: What to Carry in {year}",
  metaDescription:
    "The currency in egypt is the Egyptian pound, and the rate floats. Where to change money, which ATMs to use, what cards are good for, and why small notes matter.",
  excerpt:
    "The Egyptian pound floats, so no page should quote you a rate. What to actually do instead: where to withdraw, what cards cover, and the small note problem.",
  heroAlt:
    "A hand holding folded Egyptian pound notes at a market stall, the currency in egypt",
  wordRange: [1200, 1400],
  body: `
<p>Egypt uses the Egyptian pound, written LE or EGP. Bring a debit card and withdraw from bank ATMs on arrival rather than changing cash at home. Carry a small reserve of US dollars for emergencies, and get a thick stack of the smallest notes for tipping.</p>
...
`,
  faqs: [
    ...
    { q: "What is the exchange rate for the Egyptian pound?",
      a: "It floats and it has moved a great deal in recent years, so no travel page should quote you 1 number. Check your banking app or a live currency site on the day. Photographing the rate on your first morning gives you a reference point for the week and stops the arithmetic becoming an argument." },
    { q: "Should you accept the ATM offer to charge in your own currency?",
      a: "No, never. That option is dynamic currency conversion and the rate is set by the machine's operator rather than by your bank, which means you lose on every withdrawal. Choosing to be billed in Egyptian pounds is cheaper 100 percent of the time, with no exceptions worth looking for." },
    { q: "Is it worth bringing US dollars to Egypt?",
      a: "A small reserve, yes. Clean untorn notes are useful for a visa on arrival, which is bought in cash at a bank counter, and as a fallback if a card fails. Do not plan to spend them: paying in dollars means accepting somebody else's rate on all 3 or 4 transactions you use them for." },
    { q: "Do you need cash in Egypt or are cards enough?",
      a: "Both, in different places. Cards cover hotels, better restaurants, larger shops and pre-booked arrangements. Cash covers markets, taxis, tips, small cafes and minor entrance charges, which is most of the 10 or so transactions in a normal day. Carry 1 backup card kept somewhere separate." },
    { q: "Why do you need small notes in Egypt?",
      a: "Because tipping is constant and ATMs dispense large notes. With only large notes you will either overtip on all 20 of the small services in a week or spend it asking people to break them. Change 1 large note into small ones at the hotel desk on arrival and again mid trip." },
    { q: "What should you do with leftover Egyptian pounds?",
      a: "Spend them before you leave. Pounds are not easy to change back at a decent rate once you are outside the country, so plan your last withdrawal for the final 2 or 3 days rather than taking a round number out on arrival. Airport shops before security take both pounds and cards." },
  ],
};
