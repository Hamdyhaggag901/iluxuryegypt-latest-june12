...
<p>One last practical note: the tomb numbers are painted above the entrances but the names are not always signed clearly. Write your three down, with the KV numbers, before you hand over your ticket. Staff at the doors work from numbers, not from pharaohs.</p>',
  ...
  '[{"id":"df72b399-e433-4704-ab8a-e34f190be341","question":"How many tombs does the general Valley of the Kings ticket cover?","answer":"3 tombs, chosen by you at the gate from whatever is open that day. The open list is usually between 8 and 12 and changes as conservation work moves around the valley, because visitor breath and sweat damage painted plaster. It is not published far enough ahead to plan around, so decide from a priority order."},{"id":"5355ddd1-6f6f-4ed0-ba24-265b7ff96336","question":"How many tombs are in the Valley of the Kings in total?","answer":"65 have been found and numbered, from KV1 to KV65. Only 8 to 12 are open to visitors at any one time. The number has moved before and may move again: KV64 and KV65 were both identified in the 2000s, so the valley is not a closed set even after 2 centuries of excavation."},{"id":"9fd3b2a9-0882-42a6-830f-a9f9f8fa5cd4","question":"Which 3 tombs should you choose in the Valley of the Kings?","answer":"Ramesses VI (KV9) for its astronomical ceiling, Ramesses III (KV11) for the daily life scenes in its side chambers, and Merenptah (KV8) for the scale of its descent. If one is closed, Ramesses IV (KV2) near the entrance is the easiest substitute: short, bright and heavily decorated."},{"id":"b2814ed8-2b74-4bcc-b683-7dc4c438de9f","question":"Is the Tutankhamun tomb worth the separate ticket?","answer":"Only if the discovery story matters more to you than the painting. KV62 is small, was cut for someone else, and has decoration on 1 wall. Everything famous from it is now in the Grand Egyptian Museum. What remains is the sarcophagus, the outer coffin and the mummy in a climate controlled case."},{"id":"8a81d35b-bf4f-4096-b7e9-4847217c349f","question":"Is the Seti I tomb worth the extra cost?","answer":"Yes, if you are making 1 splurge and you care about ancient art rather than ancient celebrity. KV17 is the deepest and most completely decorated tomb in the valley, and its relief carving is better than anything else on the west bank. It was closed for decades and most visitors still walk past it."},{"id":"73083e5c-8d81-4a37-8210-59a5286d4ab6","question":"Which is better, Nefertari''s tomb or Tutankhamun''s?","answer":"Nefertari (QV66) for almost everyone. Its painting is the best preserved to survive from the ancient world, largely because the tomb was shut for most of the 20th century and has not been breathed on. Visits are capped at about 10 minutes. Tutankhamun is the more famous name and the plainer room."},{"id":"973082b5-f2dc-454b-b7fe-431064a10675","question":"What is the best time of day to visit the Valley of the Kings?","answer":"Opening time, and in summer be finished by 10am. The valley is a rock bowl with no shade that stores heat all day, and the deeper tombs are hot, still and airless rather than cool. Between October and April the timing is more forgiving, but early still means fewer people inside each tomb."},{"id":"722b23dd-91bf-4f1d-b59b-be67435c076e","question":"Do you need a photography permit inside the tombs?","answer":"Usually yes, bought separately at the ticket office, and the rules change from season to season. Ask at the window when you buy entry rather than finding out at a tomb door, which is a 15 minute walk back. Carry small notes too: the guardian at each of your 3 tombs will often light a ceiling detail you would otherwise miss."}]'::jsonb,
