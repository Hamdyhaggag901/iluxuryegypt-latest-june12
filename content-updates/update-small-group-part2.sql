...
<p>The route continues to Tell el-Amarna, Akhenaten''s erased capital, then Abydos and Dendera before reaching <a href="/egypt-travel-guide/attractions-in-luxor">Luxor</a>''s Lost Golden City, discovered in 2020 and the most significant find since Tutankhamun. <a href="/egypt-travel-guide/alexandria-egypt-attractions">Alexandria</a> follows with its Greco-Roman catacombs, then five days in <a href="/egypt-travel-guide/siwa-oasis-egypt">Siwa Oasis</a>, a Berber settlement isolated from the world until the 1980s.</p>
...
<p>From <a href="/egypt-travel-guide/aswan-egypt-attractions">Aswan</a> the itinerary continues aboard MS Le Fayan, with a Luxury Suite and private balcony, sailing north past Kom Ombo and Edfu toward <a href="/egypt-travel-guide/attractions-in-luxor">Luxor</a>. The Valley of the Kings and Karnak Temple follow, before the return flight to Cairo and a final night overlooking the Nile.</p>
