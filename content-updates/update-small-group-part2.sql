...
<p>A pre-dawn departure reaches Abu Simbel as sunrise strikes the colossal statues of Ramses II, followed by the High Dam, a Nubian village, and a sunset felucca sail with champagne. Each luxury Egypt tour package on this route includes a Luxury Suite with private balcony throughout the cruise, and ten days allows the river to set the pace, which is precisely what makes this egypt luxury tour different from a temple checklist. It sits in the middle of our <a href="/luxury-egypt-tour-packages/small-group-egypt-tours">small group Egypt tours</a> range.</p>',
  ...
  faqs = '[{"id":"471c215b-820e-4e3e-9ac5-51e78b8e03f9","question":"What''s included in your Egypt Nile cruise packages?","answer":"Nine nights of accommodation split between the Marriott Mena House in Giza and a Luxury Suite aboard MS Le Fayan, all meals, private Egyptologist guiding, domestic flights, and pre-opening Giza access."},{"id":"0f180641-bca9-4754-8cca-834ec63dc1ac","question":"How long is the Nile cruise portion?","answer":"Five nights aboard MS Le Fayan, sailing between Luxor and Aswan with stops at Edfu and Kom Ombo along the route."},{"id":"1c639ac8-9ea9-4b66-9adf-a35891d4de1f","question":"Is private pyramid access really included?","answer":"Yes. The itinerary includes pre-opening entry to the Great Pyramid''s inner chambers and the Sphinx enclosure permit, both arranged in advance."},{"id":"326191f0-65bc-462e-a5d2-ebcfa3dd0c04","question":"What is the Khonsu Temple?","answer":"A smaller temple within the Karnak complex, normally closed to visitors. Access is arranged specifically for this itinerary."},{"id":"72f2570d-003a-4cee-b036-43a29eb1ad95","question":"When is the best time for these luxury Egypt tours?","answer":"October through April offers the most comfortable sailing and temple conditions. Summer departures run but require earlier starts."}]'::jsonb,
  updated_at = now()
...
<p>Guiding is handled by a PhD-level Egyptologist throughout, and the itinerary closes with a private lecture from a renowned specialist connecting everything you have seen. Accommodation spans the <a href="/hotel/mena-house-hotel-egypt">Marriott Mena House</a>, Sofitel Winter Palace, Four Seasons Alexandria, and a kershef-built eco-lodge in Siwa. Sixteen days of this egypt luxury tour covers ground that shorter <a href="/luxury-egypt-tour-packages/small-group-egypt-tours">small group Egypt tours</a> simply cannot attempt.</p>',
  ...
  schema_type = 'TouristTrip',
  faqs = '[{"id":"bd60ae26-4536-4628-aaaa-d294bb5bbbbe","question":"What makes this one of the best luxury Egypt tours?","answer":"Access to restricted sites. Abu Rawash, Abu Sir, the Hawara Labyrinth, and the Lost Golden City all require permissions arranged in advance, and few operators include them."},{"id":"514d5ab2-de30-41aa-b00f-f8479e95ac1b","question":"Is sixteen days too long for Egypt?","answer":"Not for this route. The itinerary covers Cairo, Middle Egypt, Luxor, Alexandria, and Siwa, with genuine rest days built into the Alexandria and Siwa segments."},{"id":"e313acc6-97a8-4830-ad96-91a5ac9e593a","question":"How remote is Siwa Oasis?","answer":"Siwa sits in the Western Desert near the Libyan border, eighteen metres below sea level, and remained largely cut off until the 1980s. Its Berber culture and language remain distinct from the rest of Egypt."},{"id":"f6b0f112-b633-4f7d-87e4-b723d342d3de","question":"Who guides this egypt luxury tour?","answer":"A PhD-level Egyptologist accompanies the entire journey, and a separate private lecture with a renowned specialist closes the itinerary in Cairo."},{"id":"2228d36d-b8e6-4e2d-a9c2-0e4c2c8521f2","question":"Is this itinerary physically demanding?","answer":"Moderately. Several sites involve uneven terrain and descending into tombs, and the desert segments require long drives. It suits travellers in reasonable health."}]'::jsonb,
  updated_at = now()
...
<p>Accommodation runs from the <a href="/hotel/mena-house-hotel-egypt">Marriott Mena House</a> at the foot of the pyramids, through the Nile cruise, to the <a href="/hotel/four-seasons-first-residence-cairo">Four Seasons Cairo at The First Residence</a>. All domestic flights, private guiding, and site entries are included. A small group means the guide is genuinely yours, which makes this luxury Egypt tour feel far closer to private than shared. It is the shortest of our <a href="/luxury-egypt-tour-packages/small-group-egypt-tours">small group Egypt tours</a>.</p>',
  ...
  schema_type = 'TouristTrip',
  faqs = '[{"id":"2cef6474-abf4-4f73-9620-ab4751a98ba9","question":"How many travellers join these luxury small group tours Egypt?","answer":"Groups are capped at twelve guests, with a typical size of eight to ten, which keeps guiding personal and allows the pace to adjust."},{"id":"34191ed3-e629-4f99-a630-45b6ebc4ea0f","question":"Is private pyramid access included?","answer":"Yes. The itinerary includes after-hours entry to the Great Pyramid''s King''s Chamber and a permit to stand between the Sphinx''s paws, both arranged in advance."},{"id":"0a6c6d7c-1781-4989-a1b1-1184bc7a7993","question":"Is seven days enough for Egypt?","answer":"For the Pyramids, Abu Simbel, a Nile cruise, and Luxor''s royal tombs, yes. Travellers wanting Alexandria, Siwa, or the Red Sea should consider our longer itineraries."},{"id":"4375508f-aab5-4a32-9137-8933fe64dc5a","question":"How does this compare to your other luxury Egypt tours?","answer":"It is the shortest itinerary that still includes both private pyramid access and a Nile cruise, making it the most efficient way to see Egypt''s essentials."},{"id":"3931d1f7-2515-4acf-8538-e4b011c14c41","question":"What is MS Le Fayan?","answer":"A five-star Nile vessel where your small group occupies only a handful of suites, each with a private balcony, sailing between Aswan and Luxor."}]'::jsonb,
  updated_at = now()
