...
INSERT INTO inbound_links (source_table, source_slug, target_slug, anchor, sentence) VALUES
  ...
  ('destinations', 'attractions-in-luxor', 'what-currency-does-egypt-use', 'cash, cards and small notes', 'Entrance charges, taxis and tipping here are all cash, so {{A}} is worth reading before you arrive.'),
  ...
  ('tours', 'family-tours-egypt', 'what-currency-does-egypt-use', 'what to carry and why small notes matter', 'Families get through more small cash than anyone expects, and {{A}} explains where to get it.'),
  ...
  ('tours', 'egypt-tours-family', 'what-currency-does-egypt-use', 'where to change money and where not to', 'Cash matters more here than cards for most of what you will actually buy, and {{A}} explains why.'),
