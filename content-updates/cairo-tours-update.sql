-- Cairo/Alexandria Day Tours content update (20 tours)
-- Generated programmatically (not hand-typed) to avoid quote-escaping errors.
-- Each itinerary UPDATE preserves every pre-existing field (lat/lng/image/
-- imageAlt/day/title/activities) from the real DB record and only changes
-- description/meals/placeName (title changed only for the 2 tours flagged
-- in the review: gourmet-cairo-food-tour and cairo-tour-islamic-cairo-private-heritage-tour).
-- Run with: psql "$DATABASE_URL" -f cairo-tours-update.sql
-- Recommended: run inside a transaction and inspect row counts before commit.
...
UPDATE tours SET
  ...
  description = '<p>This Cairo Citadel Mosque Tour moves through roughly seven centuries of religious architecture in a single day, starting at the Citadel of Saladin, built as a fortress in the 1170s and still crowned by the 19th-century Muhammad Ali Mosque, whose alabaster-clad walls and Ottoman-style domes give it its local nickname, the Alabaster Mosque. From the Citadel''s terraces, the view takes in most of historic Cairo. Down in the city, Sultan Hassan Mosque represents Mamluk architecture at its most ambitious — a single building combining a mosque, a religious school, and a mausoleum on a scale rarely attempted before it — standing beside the smaller Al-Rifa''i Mosque, where several of Egypt''s 20th-century royals are buried. The tour''s last stop, Ibn Tulun Mosque, is Cairo''s oldest mosque to survive largely unchanged since it was built in 879 CE, recognizable by its spiral minaret, modeled on examples from Samarra in Iraq. Next door, the Gayer-Anderson house shows how a wealthy Ottoman-era family actually lived. Lunch, at a restaurant on historic Al-Muizz Street, closes out the day.</p>',
  itinerary = '[{"day":1,"meals":["Lunch"],"title":"Day 1 | Cairo – Citadel & Major Mosques, Medieval Islamic Quarter","placeName":"Citadel of Saladin","activities":[],"description":"Start at the Citadel of Saladin, built in the 12th century, where the Ottoman-era Muhammad Ali Mosque overlooks the city from its hilltop domes and minarets. Walk down to Sultan Hassan Mosque, a Mamluk-era complex known for its scale and geometric stonework, and the neighboring Al-Rifa''i Mosque, burial place of several members of Egypt''s royal family. The tour continues to Ibn Tulun Mosque, Cairo''s oldest mosque still standing in its original form, notable for its spiral minaret, and to the Gayer-Anderson house next door, furnished as an Ottoman-era home. Lunch is served at a restaurant along Al-Muizz Street."}]'::jsonb,
...
UPDATE tours SET
  ...
  description = '<p>A Pyramids Hot Air Balloon Sunrise Tour puts you above the Giza Plateau at the one time of day when the desert light is at its best — the hour just after sunrise, when long shadows fall across the sand and the Pyramids catch the first color of the day. Pickup is well before dawn, since timing is everything: balloon flights depend on calm morning air, and the crew will confirm conditions before you head to the launch site. Once airborne, the flight covers roughly an hour, drifting over the pyramid complex and the desert beyond, with the Sphinx and the edge of the city visible from altitude — a perspective on Giza that isn''t available from the ground. A licensed pilot handles the flying and narrates the route; a full safety briefing is given before boarding. After landing, there''s a short toast with refreshments and a printed flight certificate before the drive back to your hotel in time for breakfast. Because it depends on weather, this experience is best booked with a flexible morning.</p>',
...
UPDATE tours SET
  ...
  description = '<p>A Nile Felucca Sailing Cairo tour is the simplest way to see the city from the water, using a wooden sailboat design that hasn''t changed much since it first appeared on the river centuries ago. There''s no engine and no fixed schedule — your captain reads the wind and current, which means every sail moves at its own pace rather than a set route. Reclining on cushioned seating, you''ll pass Cairo''s riverside skyline: bridges, mosque minarets, and the gardens of older neighborhoods that back onto the Nile. The crew serves pastries, fruit, tea, and cold drinks throughout, timed so that the strongest light of the evening — the hour when the water turns amber and rose and the skyline is lit gold — falls in the middle of the sail rather than at the start or the end. Traditional music plays softly in the background. At around two hours, it''s a shorter outing than a full day tour, well suited as an evening add-on rather than a stand-alone day.</p>',
  itinerary = '[{"day":1,"lat":30.0443879,"lng":31.2357257,"image":"/api/assets/uploads/227f0e28-dd3a-4375-b586-4d4e5125cb6a.webp","title":"Day 1 | Cairo – Private Felucca Sailing","imageAlt":"Private felucca sail at Cairo with a private crew and traditional sailing rig","placeName":"Felucca","meals":[],"activities":[],"description":"Board a traditional felucca at a quiet mooring point along the Nile, fitted out with cushioned seating for comfort. Your captain explains how these wooden sailboats have worked the river for generations, relying on wind alone. As you set off, Cairo''s skyline slides past — bridges, mosques, and riverside gardens — while the crew serves pastries, fresh fruit, tea, and cold drinks. Around sunset, the water takes on shades of amber and rose, with the city''s minarets silhouetted against the sky. The sail lasts about two hours, with traditional music playing quietly in the background."}]'::jsonb,
...
UPDATE tours SET
  ...
  description = '<p>An Alexandria Day Trip from Cairo trades the desert and pharaonic monuments of most Egypt tours for something different: a Mediterranean port city built by the Greeks, ruled by Rome, and shaped since by every power that controlled the eastern Mediterranean. The Bibliotheca Alexandrina, opened in 2002 as a modern successor to the ancient Library of Alexandria, anchors the day, its manuscript collections and exhibitions giving a sense of the city''s intellectual history. From there, the Roman Amphitheater — the only one of its kind still standing in Egypt — and the third-century granite column known as Pompey''s Pillar cover the Roman period. The Qaitbay Citadel, a 15th-century fortress built on the exact site of the ancient Lighthouse of Alexandria, one of the Seven Wonders of the Ancient World, sits at the harbor mouth with sweeping Mediterranean views. A walk along the Corniche and through the gardens of Montazah Palace rounds out the afternoon before a seafood lunch by the water. Given the drive, this is a longer day than an in-Cairo tour, best suited to travelers with a full day free.</p>',
  itinerary = '[{"day":1,"lat":31.2086605,"lng":29.9089329,"image":"/api/assets/uploads/8855c6f7-a7eb-4cc3-825f-565bb10b1b61.webp","meals":["Lunch"],"title":"Day 1 | Alexandria – Bibliotheca Alexandrina, Roman Heritage, Citadel & Corniche","imageAlt":"Private guided visit to the Bibliotheca Alexandrina with a private Egyptologist guide","placeName":"Bibliotheca Alexandrina","activities":[],"description":"The coastal drive from Cairo takes a little under three hours, arriving at the Bibliotheca Alexandrina, a modern library built as a tribute to the ancient Library of Alexandria. From there, visit the Roman Amphitheater, the only Roman theater still standing in Egypt, and Pompey''s Pillar, a third-century granite column. The Qaitbay Citadel, built on the site of the ancient Lighthouse of Alexandria, one of the Seven Wonders of the Ancient World, looks out over the Mediterranean. After walking the Corniche and seeing the gardens of Montazah Palace, lunch is served at a seafood restaurant by the water."}]'::jsonb,
...
UPDATE tours SET
  ...
  description = '<p>An Egyptian Museum Downtown Cairo Tour splits the day between two very different collections: one behind glass, the other built into the streets themselves. The Egyptian Museum in Tahrir Square, still the single largest collection of pharaonic artifacts anywhere despite the newer Grand Egyptian Museum''s opening, holds around 120,000 objects, among them Tutankhamun''s gold mask and sarcophagi and a hall of preserved royal mummies — a guide familiar with the collection can point out pieces easy to miss in a museum this size. Outside, downtown Cairo''s Belle Époque district was largely built in the early 20th century, when European-trained architects designed much of the area around Talaat Harb Street and the Cairo Opera House, giving central Cairo a distinct look that survives despite decades of change. Café Riche, open since the early 1900s and a longtime meeting place for writers and political figures, is worth a stop along the walk. Lunch, at a restaurant in the same downtown streets, closes out the afternoon.</p>',
  itinerary = '[{"day":1,"lat":30.0479664,"lng":31.2336093,"image":"/api/assets/uploads/9720e9f8-04a4-4290-ab18-78d32a0246a2.webp","meals":["Lunch"],"title":"Day 1 | Cairo – Egyptian Museum Tahrir & Downtown Cairo Heritage","imageAlt":"Private guided visit to the Egyptian Museum with a private Egyptologist guide","placeName":"Egyptian Museum","activities":[],"description":"The Egyptian Museum in Tahrir Square holds around 120,000 artifacts spanning five thousand years, including Tutankhamun''s gold mask, sarcophagi, and jewelry, alongside a hall of royal mummies. From there, walk through downtown Cairo''s Belle Époque district, built in the early 20th century when European architects shaped much of the area around Talaat Harb Street and the Cairo Opera House. Café Riche, a longtime meeting place for writers and political figures, is a stop along the way. Lunch follows at a restaurant in the same downtown district."}]'::jsonb,
...
UPDATE tours SET
  ...
  description = '<p>A Giza Memphis Sphinx Tour connects the two halves of Old Kingdom Egypt that are usually seen separately: the pyramids where pharaohs were buried, and the city where they actually ruled. At Giza, the Pyramids of Khufu, Khafre, and Menkaure remain the largest stone structures built anywhere in the ancient world, with the Great Sphinx — carved directly from the plateau''s bedrock rather than built from blocks — standing guard nearby. Memphis, a short drive away, was Egypt''s capital for most of the Old and Middle Kingdoms, though little of the ancient city survives above ground; what remains is concentrated in an open-air museum, centered on a fallen colossus of Ramses II housed under a covered pavilion and a second, smaller sphinx carved from alabaster. A guide draws the connection between the two sites directly — Memphis as the administrative and religious capital, Giza as the necropolis built for its rulers just across the Nile. Lunch is included, with private transport handling the roughly thirty-minute drive between sites.</p>',
  itinerary = '[{"day":1,"lat":29.9752811,"lng":31.1375124,"image":"/api/assets/uploads/43f58122-2fee-49f4-8c22-2b9fbc9ec671.webp","meals":["Lunch"],"title":"Day 1 | Cairo – Giza Pyramids Complex & Ancient Memphis","imageAlt":"Private guided visit to the Great Sphinx with a private Egyptologist guide","placeName":"Great Sphinx","activities":[],"description":"The Pyramids of Khufu, Khafre, and Menkaure anchor the morning at Giza, followed by a close look at the Great Sphinx carved from the plateau''s limestone bedrock. From there, drive to Memphis, capital of Egypt for much of the Old and Middle Kingdoms, where a fallen colossus of Ramses II lies under a covered pavilion and a smaller alabaster sphinx stands nearby in the open-air museum grounds. A guide covers how the two sites relate — Memphis as the seat of power, Giza as its royal burial ground just across the river. Lunch is included."}]'::jsonb,
...
UPDATE tours SET
  ...
  description = '<p>This Saqqara Memphis Giza Discovery Tour is built around a single question: how did the pyramid, as a shape, actually develop? The answer unfolds across three sites in roughly the order they were built. Saqqara comes first, where Djoser''s Step Pyramid, raised around 2670 BCE, was Egypt''s first large stone monument — a stack of mastabas rather than a true pyramid, surrounded by tombs whose walls still carry sharp, well-preserved reliefs of daily Old Kingdom life. A century later at Giza, the design reaches its final, smooth-sided form in the Pyramids of Khufu, Khafre, and Menkaure, with the Great Sphinx carved from the plateau''s own bedrock nearby. The day closes in Memphis, the capital these pyramids were built to serve, where a fallen colossus of Ramses II and a second, smaller alabaster sphinx sit in an open-air museum on part of the ancient city''s original site. Seeing all three in sequence, rather than as separate day trips, makes the progression from stepped to smooth pyramid design far easier to follow than reading about it beforehand. Lunch is included between sites.</p>',
  itinerary = '[{"day":1,"lat":29.9752811,"lng":31.1375124,"image":"/api/assets/uploads/43f58122-2fee-49f4-8c22-2b9fbc9ec671.webp","meals":["Lunch"],"title":"Day 1 | Cairo – Giza Pyramids Complex, Saqqara & Memphis","imageAlt":"Private guided visit to the Great Sphinx with a private Egyptologist guide, during an intimate small-group visit","placeName":"Great Sphinx","activities":[],"description":"Start at Giza to see the Pyramids of Khufu, Khafre, and Menkaure alongside the Great Sphinx, then continue south to Saqqara for the Step Pyramid of Djoser, the oldest large stone monument in Egypt, along with mastaba tombs decorated with scenes of daily life from the Old Kingdom. The route ends in Memphis, Egypt''s ancient capital, where a colossal fallen statue of Ramses II and a smaller alabaster sphinx are displayed in an open-air setting. Covering three sites in one day traces how pyramid design changed, from Saqqara''s stepped form to Giza''s smooth-sided design a century later. Lunch is included."}]'::jsonb,
