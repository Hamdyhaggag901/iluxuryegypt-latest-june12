...
<p>It takes two minutes and nobody tells you to do it.</p>',
  ...
  '[{"id":"43b721b5-2ec9-403f-aff8-55497b726bbe","question":"How long do you need at the Grand Egyptian Museum?","answer":"Half a day, about 4 hours, is the realistic minimum for all 12 galleries at a steady pace. 2 hours covers the Grand Staircase and the Tutankhamun collection and nothing else. A full day lets you add the solar boat building and sit with what you liked rather than walking past most of it."},{"id":"47e625c2-b19b-4735-9100-3f2f853f045f","question":"Is the Grand Egyptian Museum better than the Egyptian Museum in Tahrir?","answer":"They are different rather than ranked. The Giza building is spacious, well lit and easier to follow, and holds the complete Tutankhamun collection of over 5,000 objects. Tahrir is dense, dim and atmospheric and suits return visitors. If you have 1 day, go to Giza; if you have 2, do both and put Tahrir second."},{"id":"d203e743-1217-4d3f-8dbb-6ca044ecc8b5","question":"When is the Grand Egyptian Museum least crowded?","answer":"The first hour after opening on a weekday. The Tutankhamun galleries go from comfortable to congested at around 11am, when coach groups arrive from the pyramids. If you are stuck in that window, start at the far chronological galleries and work back toward Tutankhamun in the late afternoon instead."},{"id":"46348069-ca0a-43d6-af02-b52b7bbd8bf5","question":"Is the full Tutankhamun collection at the Grand Egyptian Museum?","answer":"Yes. For the first time the complete contents of the tomb, more than 5,000 objects, are displayed together in dedicated galleries. Tahrir used to show a much smaller selection. This is the single reason most visitors travel to the Giza building rather than treating it as an optional extra stop."},{"id":"3069c72b-d372-4af8-883c-6df234fcaf8f","question":"Can you visit the Grand Egyptian Museum and the pyramids in one day?","answer":"Yes, and the order decides whether it works. Do the pyramids at sunrise and the museum from mid morning, which puts you indoors and air conditioned as the day heats up. Doing it the other way round leaves you on the plateau in flat midday light after 3 or 4 hours of walking."},{"id":"9e724bdf-be9c-4ef2-a70e-c384a8bd44ad","question":"Do you need to book Grand Egyptian Museum tickets in advance?","answer":"In high season yes, because entry is timed, which is unusual in Egypt and keeps the entry crush down. Booking ahead also skips the queue. Photography rules vary by gallery and the restricted ones are signed at the door, so check on the day rather than assuming one rule covers all 12 galleries."},{"id":"f8653971-8b2a-433a-a471-29cd46050115","question":"Is the Grand Egyptian Museum worth it for children?","answer":"Yes, more so than most Egyptian museums, because the labels are written plainly and there is room to move. The limit is distance: this is a large building on a sloped site and the default route assumes you can walk for hours. Plan at least 1 sit down break rather than pushing through."},{"id":"e423d049-a0f9-438e-8847-1b8a8866465b","question":"What should you see first at the Grand Egyptian Museum?","answer":"The Grand Staircase, on foot rather than by lift. It climbs 6 storeys lined with royal statues and sarcophagi arranged chronologically, and the window at the top frames the Giza pyramids directly. Go to the Tutankhamun galleries next, because that is the one room most people regret rushing."}]'::jsonb,
