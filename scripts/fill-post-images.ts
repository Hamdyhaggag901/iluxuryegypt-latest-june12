...
const POSTS: PostSpec[] = [
  {
    ...
    images: [
      { role: "featured", place: "Abu Simbel", city: "Aswan", keyword: true,
        queries: ["Abu Simbel temple Egypt", "Abu Simbel Ramesses colossi", "Abu Simbel Egypt facade"],
        guard: { require: [["simbel", "egypt", "egyptian", "nubia"]], deny: ["karnak", "luxor", "giza", "pyramid"] } },
      { role: "body", afterH2: 5, place: "Abu Simbel", city: "Aswan",
        queries: ["Abu Simbel statues Egypt", "ancient Egyptian colossal statue temple"],
        guard: { require: [["simbel", "statue", "temple", "egypt", "egyptian"]], deny: ["giza", "pyramid", "sphinx"] } },
      { role: "body", afterH2: 3, place: "Western Desert", city: "Aswan",
        queries: ["Egypt desert road sunrise", "Western Desert Egypt landscape", "Sahara desert road Egypt"],
        guard: { require: [["desert", "sand", "dune", "sahara"], ["egypt", "egyptian", "sahara"]], deny: ["pyramid", "giza", "city"] } },
      { role: "body", afterH2: 7, place: "Lake Nasser", city: "Aswan",
        queries: ["Lake Nasser Egypt", "Nile Aswan water Egypt", "Aswan lake Egypt landscape"],
        guard: { require: [["nasser", "nile", "aswan", "egypt"], ["lake", "water", "river"]], deny: ["cruise ship", "yacht", "marina"] } },
    ],
  },
  {
    ...
    images: [
      { role: "featured", place: "Grand Egyptian Museum", city: "Giza", keyword: true,
        ...
        guard: { require: [["museum", "gallery", "exhibit"], ["egypt", "egyptian", "cairo", "giza"]], deny: ["louvre", "british museum", "metropolitan"] } },
      { role: "body", afterH2: 1, place: "Grand Egyptian Museum", city: "Giza",
        queries: ["Egyptian museum statue gallery Cairo", "ancient Egyptian statue museum"],
        guard: { require: [["statue", "sculpture", "sarcophagus", "gallery", "museum"], ["egypt", "egyptian"]], deny: ["louvre", "british museum"] } },
      { role: "body", afterH2: 10, place: "Giza Pyramids", city: "Giza",
        queries: ["Giza pyramids Egypt", "pyramids of Giza sunrise Egypt"],
        guard: { require: [["pyramid", "pyramids", "giza"], ["egypt", "egyptian", "giza"]], deny: ["museum", "louvre", "sudan"] } },
      { role: "body", afterH2: 5, place: "Khufu solar boat", city: "Giza",
        queries: ["Khufu solar boat Egypt", "ancient Egyptian wooden boat museum", "Egyptian funerary boat"],
        guard: { require: [["boat", "ship", "vessel"], ["egypt", "egyptian", "khufu", "museum"]], deny: ["yacht", "sailing", "marina", "fishing"] } },
    ],
  },
  {
    ...
    images: [
      { role: "featured", place: "Valley of the Kings", city: "Luxor", keyword: true,
        queries: ["Valley of the Kings Luxor Egypt", "Valley of the Kings tomb entrance", "Luxor west bank valley tombs"],
        guard: { require: [["valley", "tomb", "luxor", "theban", "thebes"], ["egypt", "egyptian", "luxor"]], deny: ["hatshepsut", "karnak", "giza", "pyramid"] } },
      { role: "body", afterH2: 2, place: "Valley of the Kings", city: "Luxor",
        queries: ["ancient Egyptian painted tomb Luxor", "Egyptian tomb wall paintings hieroglyphs"],
        guard: { require: [["tomb", "painting", "painted", "hieroglyph", "relief", "wall"], ["egypt", "egyptian", "luxor"]], deny: ["museum", "replica", "giza"] } },
      { role: "body", afterH2: 6, place: "Valley of the Queens", city: "Luxor",
        queries: ["Valley of the Queens Luxor Egypt", "Nefertari tomb painting Egypt", "Egyptian queen tomb painted wall"],
        guard: { require: [["queen", "nefertari", "tomb", "painting", "painted"], ["egypt", "egyptian", "luxor"]], deny: ["hatshepsut", "karnak", "pyramid"] } },
      { role: "body", afterH2: 9, place: "Valley of the Kings", city: "Luxor",
        queries: ["Luxor west bank desert hills Egypt", "Theban hills Luxor Egypt landscape"],
        guard: { require: [["hill", "cliff", "desert", "valley", "mountain"], ["egypt", "egyptian", "luxor", "thebes", "nile"]], deny: ["pyramid", "giza", "sinai", "jordan"] } },
    ],
  },
  {
    ...
    images: [
      { role: "featured", place: "Karnak Temple", city: "Luxor", keyword: true,
        queries: ["Karnak temple Luxor Egypt columns", "Karnak hypostyle hall Egypt", "Luxor temple columns Egypt"],
        guard: { require: [["karnak", "temple", "column", "hypostyle"], ["egypt", "egyptian", "luxor"]], deny: ["greece", "athens", "rome", "pyramid"] } },
      { role: "body", afterH2: 2, place: "Hatshepsut Temple", city: "Luxor",
        queries: ["Hatshepsut temple Luxor Egypt", "Deir el Bahari temple terraces Egypt"],
        guard: { require: [["hatshepsut", "temple", "terrace", "cliff"], ["egypt", "egyptian", "luxor"]], deny: ["karnak", "pyramid", "giza"] } },
      { role: "body", afterH2: 4, place: "Luxor Temple", city: "Luxor",
        queries: ["Luxor temple at night illuminated Egypt", "Luxor temple Egypt evening lit"],
        guard: { require: [["luxor", "temple"], ["egypt", "egyptian", "luxor"]], deny: ["karnak sound", "greece", "rome"] } },
      { role: "body", afterH2: 9, place: "Nile River", city: "Luxor",
        queries: ["felucca sailing Nile Luxor Egypt", "Nile river Luxor boat sunset Egypt"],
        guard: { require: [["nile", "felucca", "boat", "river", "sail"], ["egypt", "egyptian", "luxor", "nile"]], deny: ["cruise ship", "yacht", "marina"] } },
    ],
  },
  {
    ...
    images: [
      { role: "featured", place: "Bent Pyramid", city: "Dahshur", keyword: true,
        ...
        guard: { require: [["dahshur", "bent", "pyramid", "sneferu"], ["egypt", "egyptian", "dahshur"]], deny: ["giza", "sphinx", "sudan", "mexico", "maya"] } },
      { role: "body", afterH2: 3, place: "Red Pyramid", city: "Dahshur",
        queries: ["Red Pyramid Dahshur Egypt", "Dahshur red pyramid desert Egypt"],
        guard: { require: [["dahshur", "pyramid"], ["egypt", "egyptian", "dahshur"]], deny: ["giza", "sphinx", "mexico", "maya", "sudan"] } },
      { role: "body", afterH2: 5, place: "Saqqara", city: "Cairo",
        queries: ["Saqqara pyramid Egypt", "Saqqara necropolis Egypt", "Saqqara stepped pyramid Egypt"],
        guard: { require: [["saqqara", "sakkara", "pyramid", "necropolis"], ["egypt", "egyptian", "saqqara", "sakkara"]], deny: ["giza", "sphinx", "mexico", "maya"] } },
      { role: "body", afterH2: 4, place: "Saqqara", city: "Cairo",
        queries: ["ancient Egyptian tomb relief Saqqara", "Egyptian mastaba tomb carving"],
        guard: { require: [["relief", "carving", "carved", "hieroglyph", "tomb"], ["egypt", "egyptian", "saqqara"]], deny: ["museum replica", "greece", "rome"] } },
    ],
  },
];
