...
const fallbackSlides: Slide[] = [
  {
    id: "1",
    type: "image",
    src: "/pyramids-giza-luxury-egypt-tour.webp",
    alt: "Private Giza Pyramid tour at sunset for American travelers",
    ...
    cta: { text: "Explore Pyramid Tours", link: "/egypt-tour-packages" },
  },
  {
    id: "2",
    type: "image",
    src: "/luxury-nile-cruise-egypt.webp",
    alt: "Exclusive luxury Nile cruise ship Egypt American travelers",
    ...
    cta: { text: "View Nile Cruises", link: "/egypt-nile-cruise-tours" },
  },
  {
    id: "3",
    type: "image",
    src: "/luxury-cairo-nile-view-hotel.webp",
    alt: "Luxury Cairo 5-star hotel Nile view suite balcony",
    subtitle: "Unwind in Paradise",
    title: "Luxury Cairo Hotels",
    description: "Awaken to breathtaking Nile views from your private balcony suite in Cairo's most exclusive 5-star hotels",
    cta: { text: "Discover Cairo Hotels", link: "/stay" },
  },
];
