...
/** Converts a two-letter ISO 3166-1 alpha-2 code to its flag emoji (regional indicator symbols). */
...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { name: "Congo (Republic)", iso: "CG", dialCode: "+242" },
      ...
      <SelectTrigger className="w-[105px] shrink-0 px-2.5" data-testid={testId}>
        <SelectValue>
          <span className="flex items-center gap-1.5">
            <span aria-hidden="true">{isoToFlag(selected.iso)}</span>
            {selected.dialCode}
          </span>
        </SelectValue>
      </SelectTrigger>
